...
Public Property Get MenuForm() As frmMDI
     Set MenuForm = m_Form
End Property
Public Property Let MenuForm(ByVal vNewValue As frmMDI)
...
Public Function OwnMenuProc(ByVal hWnd As Long, ByVal wMsg As Long, ByVal wParam As Long, ByVal lParam As Long) As Long
     OwnMenuProc = frmMDI.MsgProc(hWnd, wMsg, wParam, lParam)
End Function
